      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Inicio</a></span> <span class="mr-2"><a href="index.html">Productos</a></span> <span>{{$producto->producto}}</span></p>
            ...
            <div class="d-flex align-items-center justify-content-center">
                ...
                <p><a href="{{ route('productos.edit', $producto->id) }}" class="btn btn-primary ml-3">Eliminar producto</a></p> 
            </div>
          </div>
        </div>
      </div>
